...
;// CONCATENATED MODULE: ./src/assets/js/classes/PlayPreviewController.js
...
var PlayPreviewController = /*#__PURE__*/_createClass(function PlayPreviewController(videoSection) {
  var _this = this;
  _classCallCheck(this, PlayPreviewController);
  // Play video
  _defineProperty(this, "playPause", function () {
    _this.videoSection.addEventListener('mouseover', function (e) {
      if (e.target.closest('.video-preview__video')) {
        var video = e.target.closest('.video-preview__video');
...
;// CONCATENATED MODULE: ./src/assets/js/home.js
...
if (document.querySelector('.videos-preview')) {
  var PlayPausePreview = new PlayPreviewController(document.querySelector('.videos-preview'));
  PlayPausePreview.playPause();
}
if (document.querySelector('.best-scenes__list')) {
  var PlayPauseBestScenes = new PlayPreviewController(document.querySelector('.best-scenes__list'));
  PlayPauseBestScenes.playPause();
}
if (document.querySelector('.video__other')) {
  var _PlayPauseBestScenes = new PlayPreviewController(document.querySelectorAll('.best-scenes__list')[1]);
  _PlayPauseBestScenes.playPause();
}
// End Video play

if (document.querySelector('.video-full__desc-show-btn')) {
  document.querySelector('.video-full__desc-show-btn').addEventListener('click', function (e) {
...
var LanguageSwitcherContoller = /*#__PURE__*/home_createClass(
/**
 * Class contrucor
 ...
 */
function LanguageSwitcherContoller(btn, dropdown, btnActiveClass, dropdownActiveClass) {
  var _this = this;
  home_classCallCheck(this, LanguageSwitcherContoller);
  /**
   * Btn click handler
   */
  home_defineProperty(this, "btnClickHandler", function () {
   ...
   * Show dropdown
   */
  home_defineProperty(this, "showDropdown", function () {
    if (!_this.dropdown.classList.contains(_this.dropdownActiveClass)) {
      window.addEventListener("click", _this.closeOnBackdrop);
    } else {
      window.removeEventListener("click", _this.closeOnBackdrop);
    }
    _this.btn.classList.toggle(_this.btnActiveClass);
    _this.dropdown.classList.toggle(_this.dropdownActiveClass);
  });
  /**
   * Hide dropdown
   */
  home_defineProperty(this, "hideDropDown", function () {
    _this.btn.classList.remove(_this.btnActiveClass);
    _this.dropdown.classList.remove(_this.dropdownActiveClass);
  });
  home_defineProperty(this, "closeOnBackdrop", function (e) {
    if (!_this.dropdown.contains(e.target) && !_this.btn.contains(e.target) && !e.target !== _this.dropdown && e.target !== _this.btn) {
      _this.hideDropDown();
    }
  });
  this.btn = btn;
...
var lngSwitchers = Array.from(document.querySelectorAll('.lng-swtch'));
var languageSwitcherBtn_activeClass = 'lng-swtch__active--active',
  languageSwitcherDropdown_activeClass = 'swtch-list--active';
lngSwitchers.forEach(function (switcher) {
  var languageSwitcherBtn = switcher.querySelector('#lngSwtchBtn'),
    languageSwitcherDropdown = switcher.querySelector('#lngSwtchDropdown');
  var lngSwtch = new LanguageSwitcherContoller(languageSwitcherBtn, languageSwitcherDropdown, languageSwitcherBtn_activeClass, languageSwitcherDropdown_activeClass);
  lngSwtch.btnClickHandler();
});
var elMobileNav = document.getElementById('mobileNav');
var clsMobileNavActive = 'active';
var header = document.querySelector('.header');
var clsMobileMenuOpenHeader = 'mobile-menu-open';
var MobileNavController = /*#__PURE__*/home_createClass(function MobileNavController() {
  home_classCallCheck(this, MobileNavController);
});
home_defineProperty(MobileNavController, "openMenu", function () {
  elMobileNav.classList.add(clsMobileNavActive);
  header.classList.add(clsMobileMenuOpenHeader);
});
home_defineProperty(MobileNavController, "closeMenu", function () {
  elMobileNav.classList.remove(clsMobileNavActive);
  header.classList.remove(clsMobileMenuOpenHeader);
});
var HamburgerController = /*#__PURE__*/home_createClass(function HamburgerController() {
  var _this2 = this;
  home_classCallCheck(this, HamburgerController);
  /**
   * Handle click on hamburger button
   */
  home_defineProperty(this, "handleHamburgerClick", function () {
    _this2.elHamburgerBtn.addEventListener('click', function () {
      if (!_this2.menuIsOpen) {
        _this2.hamburgerMenuActivate();
      } else {
        _this2.hamburgerMenuDisabeling();
      }
    });
  });
  /**
   ...
   */
  home_defineProperty(this, "hamburgerMenuActivate", function () {
    _this2.elHamburgerBtn.classList.add(_this2.hamburgerActive);
   ...
   */
  home_defineProperty(this, "hamburgerMenuDisabeling", function () {
    _this2.elHamburgerBtn.classList.remove(_this2.hamburgerActive);
...
var hamburger = new HamburgerController();
...
document.addEventListener('click', function (e) {
  ...
  if (window.innerWidth < 960) {
    ...
    if (e.target.closest('.list__title')) {
      var title = e.target.closest('.list__title');
      title.closest('.list').classList.toggle('active');
    }
  }
});
var showProperVideoCount = function showProperVideoCount(videos) {
  var max_video_count = 8;
  var min_video_count = 4;
  ...
  if (videos.length < max_video_count) {
    videos.slice(0, min_video_count).map(function (v) {
      return v.style.display = 'block';
    });
    videos.slice(min_video_count, videos.length).map(function (v) {
      return v.style.display = 'none';
    });
  } else {
    videos.slice(0, max_video_count).map(function (v) {
      return v.style.display = 'block';
    });
    videos.slice(max_video_count, videos.length).map(function (v) {
      return v.style.display = 'none';
    });
  }
};
var bestScenesLists = Array.from(document.querySelectorAll('.best-scenes__list'));
if (bestScenesLists.length > 0) {
  bestScenesLists.forEach(function (sceneContainer) {
    var videos = Array.from(sceneContainer.querySelectorAll('.video-preview'));
    showProperVideoCount(videos);
    window.addEventListener("resize", function () {
      return showProperVideoCount(videos);
    });
  });
}
/******/ })()
